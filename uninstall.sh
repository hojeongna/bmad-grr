...
echo "               refine-story, quick-story, design-pass, qa-test, design-handoff"
...
rm -rf "$CLAUDE_DIR/workflows/design-handoff"
...
rm -f "$CLAUDE_DIR/commands/bmad-grr-design-handoff.md"
