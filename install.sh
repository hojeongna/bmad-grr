...
echo "  /bmad-grr-customize          - Apply ouroboros gate customizations to a BMAD project (per-project)"
echo ""
...
echo ""
echo "=== Optional: Ouroboros gate for create-* workflows ==="
echo ""
echo "grr ships customizations that gate the four upstream BMAD create-* workflows"
echo "with Ouroboros (https://github.com/Q00/ouroboros) — ambiguity scoring,"
echo "AC compliance evaluate, and convergence loops."
echo ""
echo "To enable in a BMAD project, run /bmad-grr-customize from inside that project."
echo "It checks Ouroboros plugin availability, copies the customization tomls into"
echo "<project>/_bmad/custom/, and reports next steps."
